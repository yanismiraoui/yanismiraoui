...
- [ASVZ Automatic booker 🤖](https://asvz-booker.herokuapp.com/) :arrow_right: Username: **"Yanis"** / Password: **""** (contact me if you want access to the code of this bot 📬)
...
- NFT Trading 🎴💲
- M4R Project: Unsupervised Learning applied to TCR and antigen bindings (SARS-COV2) 🫁🫀
